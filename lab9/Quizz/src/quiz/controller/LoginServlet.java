 ...
 * This servlet is responsible for processing the login request,
 * authenticating the user, and redirecting them to the home page
...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            // If login is successful, store the user in the session and redirect to the home page
            if (user != null) {
